...
const Expertise: React.FC = () => {
  return (
    <div className="animate-in fade-in duration-1000">
      ...
      <section id="services" className="py-20 md:py-40 bg-slate-50 overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 md:mb-32">
            ...
            {SERVICES.map((s, idx) => (
              <section key={s.id} className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-32 ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                <div className="lg:w-1/2">
                  <div className="bg-slate-900 text-white w-16 h-16 md:w-20 md:h-20 rounded-xl md:rounded-2xl flex items-center justify-center mb-6 md:mb-10 shadow-2xl group hover:rotate-12 transition-transform">
                    {s.icon}
                  </div>
                  <h3 className="text-3xl md:text-5xl lg:text-7xl font-black mb-6 md:mb-8 tracking-tighter leading-[0.9] italic uppercase">{s.title}</h3>
                ...
                <div className="lg:w-1/2 relative group w-full">
                  <div className="relative rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-3xl aspect-video md:aspect-auto">
                    <img 
                      src={s.imageUrl} 
                      alt={s.title} 
